    ...
    <section className='app__section app__flex about'>
      ...
      <div className='app__flex'>
        <div>
          ...
          <p className=''>
            Hey! It's David Kinyanjui and I'm a passionate Full stack developer focused on delivering responsive, scalable and reliable applications. I'm open to Job opportunities where I can contribute, learn and grow.
            <br/>
            <br/>
