...
let baseUrl = process.env.NODE_ENV === 'production' ? "http://localhost:4000/": "";
...
export const roles = [
    ...
    },
    {
        ...
        description: "I can build efficient api's with various back-end technologies foused on Java, Springboot framework and nodejs framework",
        technologies: ["Node.js", "Express", "MYSQL", "MongoDB", "RESTFUL-API", "GRAPHQL", "JAVA"]
    },
    {
        logo: FullStack1,
